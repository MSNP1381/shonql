...
public class ShonqolParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, Identifier=6, STRING=7, NUMBER=8, 
		WS=9;
	public static final int
		RULE_program = 0, RULE_statement = 1, RULE_assignment = 2, RULE_expression = 3, 
		RULE_functionCall = 4, RULE_arguments = 5, RULE_literal = 6;
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, null, null, null, "Identifier", "STRING", "NUMBER", 
			"WS"
		};
	}
